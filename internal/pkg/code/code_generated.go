...
// Code generated by "codegen -type=int /Users/lvsongke/workspace/go/golang/src/github.com/notone0010/pigpig/internal/pkg/code"; DO NOT EDIT.
...
func init() {
	...
	register(ErrRemoteUnreached, 502, "Error occurred while requesting remote server")
	register(ErrRemoteTimeout, 504, "Timeout occurred while requesting remote server")
	register(ErrContentDecodingFailed, 500, "Error occurred while remote response content decoding")
	register(ErrContentEncodingFailed, 500, "Error occurred while remote response content encoding")
	register(ErrProxyInternal, 500, "An internal error occurred while the proxy server is processing")
}

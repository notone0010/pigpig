...
// SetKey will create (or update) a key value in the transport.
...
// IncreaseWithExpire will increment a key in redis.
func (r *RedisCluster) IncreaseWithExpire(keyName string, expire int64) int64 {
